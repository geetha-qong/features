...
def run_migrations():
    ...
    new_columns = [
        ...
        # Graph enrichment stage status (FEATURES #77). Tracks Pass 3 + enrichment
        # separately from the CSV pipeline so "Done" only shows when everything is ready.
        ("jobs", "graph_status", "TEXT"),
        ("jobs", "ocr_status", "TEXT"),
