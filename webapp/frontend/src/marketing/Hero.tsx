...
export default function Hero({ onCTA }: HeroProps) {
  return (
    ...
    >
      ...
      <div
        className="container"
        style={{ position: "relative", display: "grid", gridTemplateColumns: "1.1fr 1fr", gap: 60, alignItems: "center" }}
      >
        <div>
          <div className="overline-tag" style={{ color: "var(--qong-violet-300)" }}>
          ...
          >
            ...
            <span className="qong-mark">QONG</span> Systems bridges traditional
            industrial design and modern digital engineering across FEED,
            instrumentation, mechanical, and electrical on one platform.
          </p>
          ...
          <div style={{ display: "flex", gap: 12, marginTop: 32 }}>
            <Link
              ...
              onClick={() => onCTA?.("Demo requested — we'll be in touch")}
            >
              Request Demo →
            </Link>
            <a
              ...
              onClick={() => onCTA?.("Loaded the platform overview")}
            >
              Explore Platform
            </a>
          </div>
          ...
          >
            {([["800+", "Instruments"], ["180+", "Datasheets"], ["<5 min", "Per P&ID"]] as [string, string][]).map(
              ([n, l]) => (
                <div key={l}>
                  <div
                    style={{
