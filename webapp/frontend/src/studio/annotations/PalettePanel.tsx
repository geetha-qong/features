...
import { Activity, ArrowRight, Boxes, ChevronDown, Wrench } from "lucide-react";
...
interface CategoryDef {
  key: "valve" | "instrument" | "equipment" | "annotation";
  label: string;
  Icon: typeof Wrench;
  items: PaletteItem[];
}
...
const ANNOTATION_ITEMS: PaletteItem[] = (PALETTE.annotation ?? []).map((it) => ({
  ...it,
  label: it.label ?? it.sub,
}));
...
const CATEGORIES: CategoryDef[] = [
  ...
  { key: "annotation", label: "Annotations", Icon: ArrowRight,  items: ANNOTATION_ITEMS },
];
