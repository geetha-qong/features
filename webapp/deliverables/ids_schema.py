...
def _f(header: str, col: str, source: str) -> IdsField:
    ...
    if primary == "vendor":
        ...
        return IdsField(header=header, path=path, source="vendor", editable=False)
    ...
    return IdsField(header=header, path=path, source=primary, editable=True)
...
COMMON_SECTIONS: List[IdsSection] = [
    IdsSection("Identity", [
        ...
        _f("Equipment No.", "equipment_no", "PROCESS"),
        _f("Equipment System", "equipment_system", "PROCESS"),
        _f("Line No.", "line_no", "PROCESS"),
        _f("Line Size", "line_size", "PROCESS"),
        _f("Schedule", "line_schedule", "PROCESS"),
        _f("Pipe Class", "pipe_class", "PROCESS"),
        _f("Pipe Material", "pipe_material", "PROCESS"),
        _f("Insulation", "insulation", "PROCESS"),
    ]),
    IdsSection("Area Classification", [
        _f("Hazardous Area Classification", "area_classification", "PROCESS"),
        _f("Temp Class (T3/T6)", "temp_class", "PROCESS"),
        _f("Ignition Group", "ignition_group", "PROCESS"),
        _f("Ambient Temp Min", "ambient_temp_min", "PROCESS"),
        _f("Ambient Temp Max", "ambient_temp_max", "PROCESS"),
    ]),
    IdsSection("Process Fluid", [
        _f("Fluid Name", "fluid_name", "PROCESS"),
        _f("Fluid State", "fluid_state", "PROCESS"),
        _f("Fluid Phase", "fluid_phase", "PROCESS"),
        _f("Density", "density", "PROCESS"),
        _f("Viscosity", "viscosity", "PROCESS"),
        _f("Molecular Weight", "molecular_weight", "PROCESS"),
    ]),
    IdsSection("Operating & Design Conditions", [
        _f("Operating Pressure Min", "operating_pressure_min", "PROCESS"),
        _f("Operating Pressure Normal", "operating_pressure_nor", "PROCESS"),
        _f("Operating Pressure Max", "operating_pressure_max", "PROCESS"),
        _f("Operating Pressure Unit", "operating_pressure_unit", "PROCESS"),
        _f("Operating Temp Min", "operating_temp_min", "PROCESS"),
        _f("Operating Temp Normal", "operating_temp_nor", "PROCESS"),
        _f("Operating Temp Max", "operating_temp_max", "PROCESS"),
        _f("Operating Temp Unit", "operating_temp_unit", "PROCESS"),
        _f("Design Pressure Min", "design_pressure_min", "PROCESS"),
        _f("Design Pressure Max", "design_pressure_max", "PROCESS"),
        _f("Design Pressure Unit", "design_pressure_unit", "PROCESS"),
        _f("Design Temp Min", "design_temp_min", "PROCESS"),
        _f("Design Temp Max", "design_temp_max", "PROCESS"),
        _f("Design Temp Unit", "design_temp_unit", "PROCESS"),
    ]),
    IdsSection("Requirements & Certification", [
        _f("NACE Requirement", "nace_requirement", "PROCESS/USER"),
        _f("IBR Requirement", "ibr_requirement", "PROCESS/USER"),
        _f("SIL Level Required", "sil_level_required", "PROCESS/USER"),
    ...
    IdsSection("Commercial / Sign-off", [
        ...
        _f("Part Number", "part_number", "VENDOR"),
        _f("MR No.", "mr_no", "USER"),
        _f("PO No.", "po_no", "USER"),
        _f("MOC No.", "moc_no", "USER"),
        _f("Job ID", "job_id_ref", "USER"),
        _f("Requisition No.", "requisition_no", "USER"),
        _f("Material Code", "material_code", "USER"),
...
_PT_SECTIONS: List[IdsSection] = [
    ...
    IdsSection("Range", [
        _f("Instrument Range Min", "instrument_range_min", "USER"),
        _f("Instrument Range Max", "instrument_range_max", "USER"),
        _f("Instrument Range Unit", "instrument_range_unit", "USER"),
