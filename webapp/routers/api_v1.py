...
async def datasheet_pdf_proxy(
    ...
    """Fetch a datasheet PDF from an internal server and stream it back to the browser."""
    import httpx
    ...
    try:
        ...
        raise HTTPException(status_code=502, detail=f"Could not fetch datasheet: {exc}")
