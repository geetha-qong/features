...
class Job(Base):
    ...
    graph_status = Column(String, nullable=True)  # None/pending/running/done/failed — graph enrichment stage
    ocr_status = Column(String, nullable=True)    # None/pending/done — bbox OCR stage
